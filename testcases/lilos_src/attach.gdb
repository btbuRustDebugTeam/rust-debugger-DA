...
echo \n[lilos-src] ARD commands installed.\n
echo [lilos-src] source directory: /home/user/lilos/testsuite/src\n
echo [lilos-src] Manual next steps:\n
echo   ardb-load-whitelist /home/user/RustDebug/rust-debugger-DA/testcases/lilos_src/temp/poll_functions.txt\n
echo   ardb-trace lilos_testsuite::run_test_suite\n
echo   break lilos::exec::YieldCpu::poll\n
echo   continue\n
echo   interrupt\n
