...
function logDapRevealDebug(message, data = {}) {
...
function logRevealStopLocation(message, data = {}) {
...
function logAutoRevealStopLocation(message, data = {}) {
...
function handleRevealStopLocation(request) {
